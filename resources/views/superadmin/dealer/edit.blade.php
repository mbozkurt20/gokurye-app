                            ...
                            <form method="post" action="{{route('superadmin.dealer_update', $dealer->id)}}">
                                ...
                                <div class="row">
                                    ...
                                    <div class="mb-3 col-md-4">
                                        ...
                                        <input required type="tel" value="{{ $dealer->phone }}" class="form-control" name="phone"
                                    ...
                                    <div class="mb-3 col-md-4">
                                        ...
                                        <input value="{{$dealer->latitude}}" required type="text" class="form-control" id="latit" name="lat" placeholder=""  >
                                    </div>
                                    <div class="mb-3 col-md-4">
                                        <label class="form-label text-black">Lokasyon (Longitude)</label>
                                        <input value="{{$dealer->longitude}}" required type="text" id="longi" class="form-control" name="lng" placeholder="" >
                                    </div>
                                </div>
