    ...
    <div class="container-fluid">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap">
            ...
            <div class="d-flex align-items-center flex-wrap">
                <a href="{{ route('restaurant.couriers.new') }}" class="special-button me-3 mb-2">
                        ...
                        <tr id="data_{{ $courier->id }}">
                            ...
                            <td>
                                <div class="d-flex">
                                    ...
                                    <a href="{{ route('restaurant.couriers.edit', $courier->id) }}" class="special-button btn-xs me-1">
        ...
        function DeleteFunction(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        type: 'GET',
                        url: '/restaurant/couriers/delete/' + id,
