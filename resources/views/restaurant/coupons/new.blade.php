...
@section('content')
    <div class="container-fluid">
        <div class="mb-sm-4 d-flex flex-wrap align-items-center text-head">
            <h2 class="mb-3 me-auto">Kupon Tanımla</h2>
            <div>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="/restaurant/categories">Kupon Tanımla</a></li>
            ...
            <div class="col-xl-8 col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Yeni Kupon Tanımla</h4>
                    </div>
                    <div class="card-body">
                            ...
                            <form method="post" action="{{route('restaurant.coupons.create')}}">
                                ...
                                <div class="row">
                                    <div class="mb-3 col-md-4">
                                        ...
                                        <input required type="text" class="form-control" name="name" placeholder="Kupon Adı">
                                    </div>
                                    <div class="mb-3 col-md-4">
                                        <label class="form-label">Kupon Açıklması (opsiyonel)</label>
                                        <input type="text" class="form-control" name="description" placeholder="Kupon Açıklaması">
                                    </div>

                                    <div class="mb-3 col-md-4">
                                        <label class="form-label">Kupon Tutarı</label>
                                        <input required type="number" class="form-control" name="total_seller_amount" placeholder="Kupon Tutarı">
                                    </div>
                                </div>
