                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="relative">
                                        ...
                                        <input value="{{$expense->amount}}" required type="number" step="0.01" class="form-control !rounded-2xl !py-3.5 !pl-10 border-slate-100 font-bold text-slate-700 shadow-sm" name="amount" placeholder="0.00">
                                    </div>
                                </div>
