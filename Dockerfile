...
RUN apt-get update \
    && apt-get install -y gnupg gosu curl ca-certificates zip unzip git supervisor sqlite3 libcap2-bin software-properties-common \
...
COPY vendor/laravel/sail/runtimes/8.0/php.ini /etc/php/8.2/cli/conf.d/99-sail.ini
